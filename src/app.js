...
var MenuLayer = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        // Fondo
        var spriteFondoTitulo= new cc.Sprite(res.menu_titulo_2_png);
        ...
        this.menuBotonJugar = new cc.MenuItemSprite(
        ...
        var menu = new cc.Menu(this.menuBotonJugar);
        // Asigno posición central
        ...
        return true;
               ...
               this.menuBotonJugar.setEnabled(false);
    }, onEnterTransitionDidFinish : function() {
           this.menuBotonJugar.setEnabled(true);
    }
});
